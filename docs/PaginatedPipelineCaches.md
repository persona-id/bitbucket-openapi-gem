# Bitbucket::PaginatedPipelineCaches
...
| **values** | [**Array&lt;PipelineCache&gt;**](PipelineCache.md) | The values of the current page. | [optional] |
...
instance = Bitbucket::PaginatedPipelineCaches.new(
  page: null,
  values: null,
  size: null,
  pagelen: null,
