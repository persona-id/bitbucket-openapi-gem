...
api_instance = Bitbucket::SourceApi.new
...
begin
  ...
  puts "Error when calling SourceApi->repositories_workspace_repo_slug_filehistory_commit_path_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SourceApi->repositories_workspace_repo_slug_filehistory_commit_path_get_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SourceApi->repositories_workspace_repo_slug_src_commit_path_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SourceApi->repositories_workspace_repo_slug_src_commit_path_get_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SourceApi->repositories_workspace_repo_slug_src_get: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SourceApi->repositories_workspace_repo_slug_src_get_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SourceApi->repositories_workspace_repo_slug_src_post: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SourceApi->repositories_workspace_repo_slug_src_post_with_http_info: #{e}"
end
```
