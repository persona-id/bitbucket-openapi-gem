  ...
  class User
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Bitbucket::User` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Bitbucket::User`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'has_2fa_enabled')
        self.has_2fa_enabled = attributes[:'has_2fa_enabled']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          has_2fa_enabled == o.has_2fa_enabled &&
          nickname == o.nickname &&
          is_staff == o.is_staff &&
          website == o.website
    end
    ...
    def hash
      [links, account_id, account_status, has_2fa_enabled, nickname, is_staff, website].hash
    end
