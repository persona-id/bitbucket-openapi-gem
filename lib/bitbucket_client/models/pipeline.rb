...
module Bitbucket
  ...
  class Pipeline
    ...
    attr_accessor :build_seconds_used
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Bitbucket::Pipeline` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Bitbucket::Pipeline`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'build_seconds_used')
        self.build_seconds_used = attributes[:'build_seconds_used']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          build_seconds_used == o.build_seconds_used
    end
    ...
    def hash
      [uuid, build_number, creator, repository, target, trigger, state, created_on, completed_on, build_seconds_used].hash
    end
