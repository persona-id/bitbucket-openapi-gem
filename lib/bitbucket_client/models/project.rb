...
module Bitbucket
  ...
  class Project
    ...
    attr_accessor :has_publicly_visible_repos
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Bitbucket::Project` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Bitbucket::Project`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'has_publicly_visible_repos')
        self.has_publicly_visible_repos = attributes[:'has_publicly_visible_repos']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          has_publicly_visible_repos == o.has_publicly_visible_repos
    end
    ...
    def hash
      [links, uuid, key, owner, name, description, is_private, created_on, updated_on, has_publicly_visible_repos].hash
    end
