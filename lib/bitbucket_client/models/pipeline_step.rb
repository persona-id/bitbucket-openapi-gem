  ...
  class PipelineStep
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Bitbucket::PipelineStep` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Bitbucket::PipelineStep`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'setup_commands')
        if (value = attributes[:'setup_commands']).is_a?(Array)
          self.setup_commands = value
        end
      end

      if attributes.key?(:'script_commands')
        if (value = attributes[:'script_commands']).is_a?(Array)
          self.script_commands = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          state == o.state &&
          image == o.image &&
          setup_commands == o.setup_commands &&
          script_commands == o.script_commands
    end
    ...
    def hash
      [uuid, started_on, completed_on, state, image, setup_commands, script_commands].hash
    end
