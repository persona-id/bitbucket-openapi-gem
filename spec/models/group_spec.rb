...
# Unit tests for Bitbucket::Group
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Bitbucket::Group do
  let(:instance) { Bitbucket::Group.new }

  describe 'test an instance of Group' do
    it 'should create an instance of Group' do
      expect(instance).to be_instance_of(Bitbucket::Group)
    end
  end
  ...
  describe 'test attribute "full_slug"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
